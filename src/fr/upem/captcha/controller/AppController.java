...
public class AppController{
	...
	private static void setupCatpcha(ArrayList<Category> categoryLevel) {
		...
		message.set("Sélectionner : " + category.getName());
	...
	public static void validate() {
		if(selectedImagesAreGood()) {
			View.alert(Alert.AlertType.INFORMATION, "Félicitations, vous n'êtes pas un robot !");
		}else {
			View.alert(Alert.AlertType.ERROR, "Désolé, vous n'avez pas réussi le test");
